...
int main() {
    ...
    FoodRatings* fr = foodRatingsCreate(foods, n, cuisines, n, ratings, n);

    printf("Highest rated Korean: %s\n", foodRatingsHighestRated(fr, "korean"));  
    printf("Highest rated Japanese: %s\n", foodRatingsHighestRated(fr, "japanese")); 

    foodRatingsChangeRating(fr, "sushi", 16);
    printf("Highest rated Japanese after sushi->16: %s\n", foodRatingsHighestRated(fr, "japanese")); 

    foodRatingsChangeRating(fr, "ramen", 16);
    printf("Highest rated Japanese after ramen->16: %s\n", foodRatingsHighestRated(fr, "japanese"));

    foodRatingsChangeRating(fr, "miso", 16);
    printf("Highest rated Japanese after miso->16: %s\n", foodRatingsHighestRated(fr, "japanese"));
